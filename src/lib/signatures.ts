...
export const signatureTemplates: Array<{ id: string; name: string; description: string; swatches: string[]; branding: Partial<SignatureBranding> }> = [
  ...
  { id: 'profile-photo', name: 'Photo Left', description: 'Put a human face at the center of the introduction.', swatches: ['#165c51', '#e5f0eb'], branding: { layout: 'photo-left', primaryColor: '#165c51', accentColor: '#e5f0eb', textColor: '#17352e', alignment: 'left', showDivider: true, buttonStyle: 'soft', iconStyle: 'outline', photoSize: 72, imageShape: 'rounded' } },
  ...
  { id: 'photo-right', name: 'Photo Right', description: 'A friendly, balanced layout with the image leading the close.', swatches: ['#1b6e60', '#d9e9e2'], branding: { layout: 'photo-right', primaryColor: '#1b6e60', accentColor: '#d9e9e2', textColor: '#173b33', alignment: 'right', showDivider: false, buttonStyle: 'soft', iconStyle: 'outline', imageShape: 'circle' } },
...
export function generateEmailSignatureHtml(signature: EmailSignature, businessCardUrl = '', options: { allowLocalImages?: boolean } = {}) {
  ...
  const contactRows = [
    visible.website !== false ? detailRow('website', contact.website, contactHref(contact.website, 'url')) : '',
