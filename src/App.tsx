...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {route === 'event-lead-capture' && <div className="dashboard-layout"><WorkspaceSidebar active="events" user={user} onCards={() => navigate('dashboard')} onOverview={() => navigate('overview')} onTemplates={() => navigate('templates')} onInsights={() => navigate('insights')} onSignatures={() => navigate('email-signatures')} onBranding={() => navigate('branding')} onSignOut={signOut} onEvents={() => undefined} /><main className="dashboard-main workspace-page-main event-workspace-main"><div className="mobile-workspace-bar"><BrandLockup /><button className="mobile-overview-link" onClick={() => navigate('dashboard')}><ArrowLeft size={14} /> Cards</button></div><EventLeadCapturePage embedded user={user} view={eventView} eventId={routeId} bundles={bundles} onNavigate={(view, id) => navigate('event-lead-capture', id, view)} onToast={showToast} /></main><MobileWorkspaceNav active="events" onCards={() => navigate('dashboard')} onOverview={() => navigate('overview')} onTemplates={() => navigate('templates')} onInsights={() => navigate('insights')} onSignatures={() => navigate('email-signatures')} onBranding={() => navigate('branding')} onCreate={createCard} onEvents={() => undefined} /></div>}
